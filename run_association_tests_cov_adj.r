# THIS FILE IS TO RUN ASSOCIATION TESTS FOR GWAS19 SIMULATED DATA #
#
# Will use parallele computing for each simulation replicate
...
rm(i)
gene.name = "MAP4" # this can be changed
simfile.id=Sys.getenv("PBS_ARRAYID")
SIMPHEN.file = paste('/home/bulllab/gaw18/gaw19/data/SIMPHEN/SIMPHEN.',simfile.id,'.csv',sep="")
